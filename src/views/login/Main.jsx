...
import vendipuntoCircle from "../../assets/images/vendipuntoCircle.png";
          ...
          <div className="block xl:grid grid-cols-2 gap-4">
            ...
            <div className="hidden xl:flex flex-col min-h-screen">
              <a href="" className="-intro-x flex items-center pt-5">
                <img
                  alt="VendiPunto"
                  className="w-310 h-10"
                  src={vendipuntoCircle}
                />
                <span className="text-white text-lg ml-3">VendiPoints</span>
              </a>
